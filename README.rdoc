...
We currently use the 1.8.6 version.  After that is installed you will need to install the rake, rubyzip(v0.9.1), and activesupport(v2.3.5) gems.
...
com.mosso.cloudfiles.integration.tests project's bin/debug folder:
...
types are explicitly used in this example. The +var+ keyword could also be used and object/collection initializers could be used. 
We are being explicit for example
