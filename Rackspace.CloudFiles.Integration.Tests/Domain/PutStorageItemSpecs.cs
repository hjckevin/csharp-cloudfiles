...
namespace Rackspace.CloudFiles.Integration.Tests.domain.PutStorageItemSpecs
{
    [TestFixture]
    public class When_putting_storage_objects : TestBase
    {
        ...
        public void Should_set_content_type_of_gif_for_stream_upload()
        {
            ...
            using (var testHelper = new TestHelper(authToken, storageUrl))
            {
                var fileStream = new FileStream(Constants.StorageItemNameGif, FileMode.Open, FileAccess.Read);
